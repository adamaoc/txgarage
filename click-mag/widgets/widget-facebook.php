...
class mvp_facebook_widget extends WP_Widget {
	...
	function mvp_facebook_widget() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'mvp_facebook_widget', 'description' => esc_html__('A widget that displays a Facebook Like Box.', 'click-mag') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'mvp_facebook_widget' );

		/* Create the widget. */
		$this->__construct( 'mvp_facebook_widget', esc_html__('Click Mag: Facebook Widget', 'click-mag'), $widget_ops, $control_ops );
	}
