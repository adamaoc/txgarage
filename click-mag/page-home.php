					...
					<section id="mvp-tab-col3" class="mvp-blog-col-wrap left relative mvp-tab-col-cont">
						<ul class="mvp-blog-col-story left relative infinite-content">
							<?php if (isset($do_not_duplicate)) { ?>
								...
								<?php endwhile; endif; ?>
							<?php } else { ?>
								<?php global $post; $mvp_posts_num = esc_html(get_option('mvp_posts_num')); $paged = (get_query_var('page')) ? get_query_var('page') : 1; query_posts(array( 'tax_query' => array( array( 'taxonomy' => 'post_format', 'field' => 'slug', 'terms' => 'post-format-video' )), 'posts_per_page' => $mvp_posts_num, 'paged' =>$paged )); if (have_posts()) : while (have_posts()) : the_post(); ?>
									<li class="infinite-post">
										<?php if (  (function_exists('has_post_thumbnail')) && (has_post_thumbnail())  ) { ?>
											<a href="<?php the_permalink(); ?>" rel="bookmark">
											<div class="mvp-blog-col-img left relative">
					...
					<section id="mvp-tab-col4" class="mvp-blog-col-wrap left relative mvp-tab-col-cont">
						<ul class="mvp-blog-col-story left relative infinite-content">
							<?php if (isset($do_not_duplicate)) { ?>
								...
								<?php endwhile; endif; ?>
							<?php } else { ?>
								<?php global $post; $mvp_posts_num = esc_html(get_option('mvp_posts_num')); $paged = (get_query_var('page')) ? get_query_var('page') : 1; query_posts(array( 'tax_query' => array( array( 'taxonomy' => 'post_format', 'field' => 'slug', 'terms' => 'post-format-gallery' )), 'posts_per_page' => $mvp_posts_num, 'paged' =>$paged )); if (have_posts()) : while (have_posts()) : the_post(); ?>
									<li class="infinite-post">
										<?php if (  (function_exists('has_post_thumbnail')) && (has_post_thumbnail())  ) { ?>
											<a href="<?php the_permalink(); ?>" rel="bookmark">
											<div class="mvp-blog-col-img left relative">
